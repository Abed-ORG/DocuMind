...
const extractionSystemInstruction = [
  ...
  "Use this exact JSON shape: {\"columns\":[\"field\",\"value\",\"type\",\"source\"],\"rows\":[{\"field\":\"\",\"value\":\"\",\"type\":\"\",\"source\":\"\",\"documentName\":\"\",\"pageNumber\":null,\"chunkIndex\":null,\"evidence\":\"\"}]}",
  ...
  "Do not invent fields, values, documents, page numbers, chunk indexes, or evidence.",
].join("\n");
